...
export default function Hero({term, setTerm}) {
  ...
  return (
    <div className="position-relative">
      <div style={{background:'transparent', zIndex: 200}} className="top-0 position-absolute w-100">
      <NavBar term={term} setTerm={setTerm} />
      </div>
      {term.length < 1 ?
 <Carousel fade controls={false} style={{height: 650}} interval={1500} >
      <Carousel.Item  style={{background: "url('/assets/images/flix.jpg')", }}>
      <div
      ...
      >
        <div className=" hero-section">
          ...
          <p className="text-white">
            Find the Latest Releases, Reviews, and Recommendations. Join the
            Movie Buff Community Today!
          </p>
      ...
      <Carousel.Item  style={{background: "url('/assets/images/flix3.jpg')", }}>
      <div
        className=" container d-flex align-items-center "
        style={{ height: 550 }}
      >
      ...
      <Carousel.Item  style={{background: "url('/assets/images/flix4.jpg')", }}>
      <div
        className=" container d-flex align-items-center "
        style={{ height: 550 }}
      >
