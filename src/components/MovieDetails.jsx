        ...
        <>
          ...
          <div className="text-container container">
            <div className="text container py-5">
              ...
              <div className="container"><Link style={{ textDecoration: "none", color: "white" }} to="/">
              ...
              >
                <div className="py-5  hero-section">
                  <p className="text-white gothic fade-in" style={{fontSize:'2.5rem'}}>{movie.title}</p>
                  <p className="text-success semibold fade-in " style={{ fontSize: 11 }}><span className="gradient-background1 rounded-pill p-2">{movie.status}</span><span className="text-white ms-2 border rounded-2 py-1 px-2">HD</span><span className="text-white ms-2 gradient-background rounded-2 py-1 px-2">{ convertToHoursAndMinutes(movie.runtime)}</span></p>
                ...
                <div className="detail-img fade-in">
                  <img src={`https://image.tmdb.org/t/p/original${movie.poster_path}`} style={{height: 400}} alt="" />
                </div>
